...
//$config['join']                = 'user_id';
//$config['columns']		= array( 'id' ,'sex', 'age');
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['message_start_delimiter'] = '<p><span class="label label-warning">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</span></p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p><span class="label label-important">';		// Error mesage start delimiter
$config['error_end_delimiter']     = '</span></p>';	// Error mesage end delimiter
